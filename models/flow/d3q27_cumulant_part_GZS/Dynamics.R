...
AddSetting(name="VelocityX", default="0m/s", comment='Inlet x velocity', zonal=TRUE)
AddSetting(name="VelocityY", default="0m/s", comment='Inlet y velocity', zonal=TRUE)
AddSetting(name="VelocityZ", default="0m/s", comment='Inlet z velocity', zonal=TRUE)
...
AddStage("MacroUpdate" , "UpdateIG_u"    , save=Fields$group %in% c("IG"), load=DensityAll$group %in% c("f")) 

AddAction("Iteration", c("BaseIteration", "MacroUpdate", "CalcF"))
