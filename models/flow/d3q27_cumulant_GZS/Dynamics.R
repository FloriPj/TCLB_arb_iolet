...
AddSetting(name="VelocityX", default="0m/s", comment='Inlet velocity X-component (overrides Velocity)', zonal=TRUE)
AddSetting(name="VelocityY", default="0m/s", comment='Inlet velocity Y-component (overrides Velocity)', zonal=TRUE)
AddSetting(name="VelocityZ", default="0m/s", comment='Inlet velocity Z-component (overrides Velocity)', zonal=TRUE)
...
AddStage("MacroUpdate" , "UpdateIG_u"    , save=Fields$group %in% c("IG"), 
...
AddField(name="NormX", comment="Wall normal x-component")
AddField(name="NormY", comment="Wall normal y-component")
AddField(name="NormZ", comment="Wall normal z-component")
AddField(name="SD", comment="Signed distance to the wall")

for (i in 0:26) {
    AddField(name=paste0("IG_f_", i), group="IG", stencil2d=1, parameter=TRUE)
}

AddField(name="IG_ux", group="IG", stencil2d=1, parameter=TRUE)
AddField(name="IG_uy", group="IG", stencil2d=1, parameter=TRUE)
AddField(name="IG_uz", group="IG", stencil2d=1, parameter=TRUE)
AddField(name="IG_rho", group="IG", stencil2d=1, parameter=TRUE)
