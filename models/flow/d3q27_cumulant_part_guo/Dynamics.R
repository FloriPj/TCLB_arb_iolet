...
AddSetting(name="VelocityX", default="0m/s", comment='Inlet velocity', zonal=TRUE)
AddSetting(name="VelocityY", default="0m/s", comment='Inlet velocity', zonal=TRUE)
AddSetting(name="VelocityZ", default="0m/s", comment='Inlet velocity', zonal=TRUE)
